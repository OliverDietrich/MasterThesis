...
if( format %in% "h5") {
  ...
  parameters <- c("pointSize","position","binSize","color","fill","shape","alpha","titleSize","axisTitle","axisXsize",
                  ...
                  ,"legendPositionX","legendPositionY","legendTitle","legendText","legendKeySize","legendBgrdCol","guideSize",
                  "fileType","dpi","width","height")
  
  boxplot <- c(1,"jitter",NA,"dataset","dataset",NA,0.5,30,30,30,0,0.5,0,30,0,0,0.5,1,
               "right","none",0,30,30,"white",5,"png",300,10,10)
  smoothDensity <- c(1,"jitter",NA,"dataset","dataset",NA,0.5,30,30,30,0,0.5,0,30,0,0,0.5,1,
                     0.7,0.7,0,30,30,"white",5,"png",300,10,10)
  scatter <- c(1,"jitter",NA,"dataset","dataset",NA,0.5,30,30,30,0,0.5,0,30,0,0,0.5,1,
               "right","none",0,30,30,"white",5,"png",300,10,10)
  hvgPlot <- c(1,"jitter",NA,"dataset","dataset",NA,0.5,30,30,30,0,0.5,0,30,0,0,0.5,1,
               "none","none",0,30,30,"white",5,"png",300,10,10)
  PCAplot <- c(1,"jitter",NA,"dataset","dataset",NA,0.5,30,30,30,0,0.5,0,30,0,0,0.5,1,
               "right","none",0,30,30,"white",5,"png",300,10,10)
  PCAloadings <- c(3,"jitter",NA,"dataset","dataset",NA,0.5,30,30,30,0,0.5,0,30,0,0,0.5,1,
                   "right","none",0,30,30,"white",5,"png",300,10,10)
  tSNE <- c(1,"jitter",NA,"dataset","dataset",NA,0.5,30,30,30,0,0.5,0,30,0,0,0.5,1,
            "right","none",0,30,30,"white",5,"png",300,10,10)
  UMAP <- c(1,"jitter",NA,"dataset","dataset",NA,0.5,30,30,30,0,0.5,0,30,0,0,0.5,1,
            "right","none",0,30,30,"white",5,"png",300,10,10)
  DM <- c(1,"jitter",NA,"dataset","dataset",NA,0.5,30,30,30,0,0.5,0,30,0,0,0.5,1,
          "right","none",0,30,30,"white",5,"png",300,10,10)
  boxplot <- c(1,"jitter",NA,"dataset","dataset",NA,0.5,30,30,30,0,0.5,0,30,0,0,0.5,1,
               "right","none",0,30,30,"white",5,"png",300,10,10)
  boxplot <- c(1,"jitter",NA,"dataset","dataset",NA,0.5,30,30,30,0,0.5,0,30,0,0,0.5,1,
